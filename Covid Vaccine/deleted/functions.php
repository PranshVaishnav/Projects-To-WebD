...
$state=$_POST['sta'];
$district=$_POST['dis'];
$sql="SELECT * FROM info where STATE=UPPER('$state')AND DISTRICT=UPPER('$district')";
...
if(mysqli_num_rows($result)==1)
{
  ...
  echo '<script>alert("No slots available here")</script>';
 ...
 <form class="conn" action="functions.php" method="post">
